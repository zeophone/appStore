...
.character3{
	...
	.select_box label { float: left; padding: 0 30upx; background: #eee; line-height: 64upx; color: #333; margin: 16upx 14upx 0 0;border-radius: 12upx; font-size: 32upx;}
	...
	.checkbox{width: 160upx;text-align: center;}
}	
