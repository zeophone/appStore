...
var _qs = _interopRequireDefault(__webpack_require__(/*! qs */ "./node_modules/qs/lib/index.js"));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var wLoading = function wLoading() {return Promise.all(/*! import() | components/w-loading/w-loading */[__webpack_require__.e("common/vendor"), __webpack_require__.e("components/w-loading/w-loading")]).then(__webpack_require__.bind(null, /*! @/components/w-loading/w-loading.vue */ "C:\\Users\\Dell\\Documents\\HBuilderProjects\\起小名\\components\\w-loading\\w-loading.vue"));};var _default =
{
  data: function data() {
    return {
      nameInfo: null,
  ...
  computed: {
    characterAll: function characterAll() {
      var arr = [];
      if (this.nameInfo) {
        var target = this.nameInfo.list;
  ...
  methods: {
    submit_pay: function submit_pay() {
      uni.navigateTo({
        url: '../pay/pay' });

    },
    headControl: function headControl() {
    ...
    goDetail: function goDetail(obj) {
      ...
      uni.navigateTo({
        url: '../child_name/child_name?' + _qs.default.stringify(params) });
